    ...
    return ( 
        <form className="bg-gray-300 p-6 flex flex-col items-center rounded-2xl gap-y-5" method="post">       
            ...
            <div className="flex flex-col items-center self-start w-full">
                <label className="" for="Luser">Username</label>            
                <div className="flex flex-row self-start w-full items-center">                                     
                    <MdOutlinePerson className=""/>
                    <input className="flex-grow" type="text" name="Luser" id="Luser" required/>              
                </div>
            </div> 
            <div className="flex flex-col items-center self-start w-full ">
                <label className="" for="Lpwd" >Password</label>
                <div className="flex flex-row self-start w-full items-center">
                    <RiLockPasswordFill className=""/>
                    <div className="flex flex-col w-full justify-center">                      
                        <input className="flex-grow" type="password" name="Lpwd" id="Lpwd" required/>   
            ...
            <div className="">
                <p className="">Don't have a account? <Link className="" to="/signup">Register</Link></p>
            </div>    
        </form>
     );
}
